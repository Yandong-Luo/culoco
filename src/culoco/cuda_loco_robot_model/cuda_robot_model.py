...
# CuRobo
from culoco.cuda_loco_robot_model.cuda_robot_generator import (
    CudaRobotGenerator,
...
from culoco.util_file import is_file_xrdf
...
class CudaLocoRobotModel(CudaRobotModel):
