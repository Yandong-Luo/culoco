...
# CuRobo
from culoco.cuda_loco_robot_model.cuda_loco_model import CudaLocoModel
...
def demo_basic_robot():
    ...
    robot_cfg = RobotConfig.from_basic(urdf_file, base_link, leg_ee_links, arm_ee_link, tensor_args)
